      ...
      <SectionShell>
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="comic-panel bg-zinc-900/30 p-6 sm:p-8">
              <ContactForm />
            </div>
          </div>
            ...
            <div className="comic-panel bg-zinc-900/30 p-6">
              ...
              <ul className="space-y-3 text-zinc-400 text-sm">
                <li className="flex items-start gap-2">
                  ...
                  <span>Submit your inquiry with event details</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#FF2436]">2.</span>
                  <span>Receive a response within 24-48 hours</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#FF2436]">3.</span>
                  <span>Schedule a consultation call if needed</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#FF2436]">4.</span>
                  <span>Receive a custom quote for your event</span>
                </li>
              </ul>
            </div>
